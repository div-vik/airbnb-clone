    ...
    <>
      <div className="flex gap-2">
        ...
        {photoLink ? (
          ...
          <button
            disabled
            className="bg-gray-200 text-black/[0.5] px-4 rounded-2xl cursor-not-allowed"
          >
            Add&nbsp;photo
          </button>
        )}
      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              <img
                ...
                src={"http://127.0.0.1:8080/uploads/" + link}
              />
              <button
        ...
        <label className="h-32 border cursor-pointer items-center justify-center gap-1 bg-transparent flex rounded-2xl p-2 text-2xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
